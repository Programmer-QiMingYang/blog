    ...
    <nav class="navbar navbar-inverse">
        ...
        <div id="navbar-menu" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">最新blog</a></li>
                <li><a href="#">最热blog</a></li>
                <li><a href="#">blog诗词</a></li>
                <li><a href="#">blog问答</a></li>
            ...
            <div class="foot" style="position: absolute;left: 0px;float: left;margin-top: 60px;">
                <div class="foot-nav clearfix">
                    ...
                    <div class="foot-nav-col">
                        ...
                        <ul>
                            <li>
                                <a href="http://www.programmer.fit" onMouseOut="hideImg()"  onmouseover="showImg()">
                                    微信
                            ...
                            <li>
                                <a href="http://www.programmer.fit" target="_blank" rel="external nofollow">
                                    QQ空间
                                </a>
                            </li>
                        </ul>
               ...
               <!-- rgba(60,63,65,0.31)-->
                ...
                <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
                    <div class="foot-copyrights" style="margin-left: 200px">
                        ...
                        <p>
                            <span>违法和不良信息举报电话：029-xxxxxxx</span>
                            <span>邮箱：qmymsn@126.com</span>
                        </p>
                        <p style="margin-top: 8px">&copy;www.programmer.fit blog版权所有</p>
                    </div>
                </div>
            </div>
            <!--col-md-9结束 -->
